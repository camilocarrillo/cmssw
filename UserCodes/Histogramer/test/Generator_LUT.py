...
process.source = cms.Source("PoolSource",
	...
	'file:/afs/cern.ch/user/m/masegura/CMSSW_9_2_5_patch2/src/L1Trigger/L1TMuonCPPF/test/SingleMuPt10_pythia8_cfi_py_GEN_SIM_DIGI_LUT.root',
	)

)

process.load('UserCodes.Histogramer.cppfgen_cfi')
process.TFileService = cms.Service("TFileService",
	fileName = cms.string("CPPF_LUT.root")
)
